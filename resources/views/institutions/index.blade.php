...
@section('content')
    <div class="h-screen mb-10">
        ...
        {{-- Контент страницы --}}
        <div class="md:bg-grey-lighter">
            <main class="container mx-auto md:bg-white md:shadow-lg">
                {{-- Реклама: топ вузы текущего года для маленьких экранов --}}
                <div class="mb-8 px-3 md:px-6 md:hidden">
                    <institution-promo-carousel></institution-promo-carousel>
                </div>

                <div class="hidden md:block md:px-6 md:py-3 md:text-blue-dark">
                ...
                <div class="hidden md:block md:px-6 md:py-3 md:mb-4 md:bg-orange">
                    <form action="{{ route('institutions.index', $institutionType) }}" method="get" class="md:w-4/5 lg:w-2/3">
                        <input type="text" placeholder="Название учебного заведения..." class="block w-full px-6 py-2 mb-3 text-lg placeholder-text-grey-dark bg-white">
                        <div class="flex">
                            <div class="w-3/5 mr-3">
                                <select class="block w-full text-grey py-2 px-4 styled-select" name="">
                    ...
                    @foreach ($institutions as $institution)
                        <div class="flex mb-6">
                            ...
                            <div class="flex-1 min-w-0 flex flex-col justify-center px-2 border-orange-light" style="border-left-width: 1.3px">
                                <div class="mb-1">
                                    <a href="{{ route('institutions.show', [ $institutionType, $institution ]) }}" class="text-blue-dark no-underline">{{ $institution->title }}</a>
                                </div>
