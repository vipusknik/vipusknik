...
<div class="flex items-center mb-3">
    ...
    <div class="lg:text-white lg:text-xl">г. {{ $institution->city->title }}, {{ $institution->address }}</div>
</div>
@endif
...
<div class="flex">
    ...
    <a href="{{ $institution->web_site_url }}" target="_blank" class="text-blue-dark lg:text-white lg:text-xl lg:no-underline">{{ $institution->web_site_display_title ?: $institution->web_site_url }}</a>
</div>
@endif
