                ...
                <div class="lg:hidden">
                    ...
                    <article class="px-3 mb-1">
                        <h4 class="flex items-center justify-center mb-3 uppercase text-blue-lightish font-franklin-gothic font-normal">
                            ...
                            <div class="mt-1 w-48 text-center xs:w-auto xs:text-left">
                        ...
                        <div class="font-cuprum text-grey-darkest">
                            ...
                            <p class="pl-3"><span class="pl-3">Мы</span> объединили на одном ресурсе ВСЕ образовательные организации Казахстана. <span class="text-blue-lightish">За Вами только выбор!</span></p>
                        </div>
                    </article>
                    ...
                    <article class="px-3 mb-3">
                        ...
                        <div class="font-cuprum text-grey-darkest">
                            <p class="mb-1">
                                <span class="pl-3">Ни</span> для кого не секрет, что в настоящее время существует большой отток казахстанских выпускников в российские и европейские вузы.
                            ...
                            <p class="mb-1">
                                <span class="pl-3">Сегодня</span> рынок труда в республике испытывает существенный дефицит квалифицированных кадров.
                            ...
                            <p>
                                <span class="pl-3">Также</span> по-прежнему существует острая нехватка в инженерно-техническом составе, в добывающей и нефтегазовой отрасли, нужны пилоты и бортинженеры, врачи, педагоги и др.
                            </p>
                        </div>
                    </article>
                    ...
                    {{-- Баннер 2 --}}
                    <div class="mb-3 px-3">
                        <a href="http://vipusknik.kz/institutions/college/ust-kamenogorskiy-mnogoprofilnyy-tehnologicheskiy-kolledzh-kguhttp://vipusknik.kz/institutions/college/ust-kamenogorskiy-mnogoprofilnyy-tehnologicheskiy-kolledzh" target="_blank">
